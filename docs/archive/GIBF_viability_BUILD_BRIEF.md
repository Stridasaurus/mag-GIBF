> **ARCHIVED — 2026-07-11.** This was Claude's one-time build spec from June 2026 (written pre-rename; see the terminology note below). It is **not current** and is kept only for history / methods-paper backfill. **Superseded by the current onboarding brief `BUILD_BRIEF.md` (repo root, 2026-07-12).** For current status, read (in this order): root `README.md`, `BUILD_BRIEF.md`, `ROADMAP.md` (canonical, live source of truth), `EXPERIMENT_CARD_A.md`, `viability-test/SPEC_experiment_B.md`.
>
